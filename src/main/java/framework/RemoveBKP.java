...
public class RemoveBKP {
    ...
    public RemoveBKP() {
        String dir = "C:\\Users\\alexa\\Desktop\\backup";
        ...
        if ( fList.length != 0 && fList.length > 8 ) {
            ...
            String nome = "C:\\Users\\alexa\\Desktop\\backup\\"+x;  
            ...
            while (m < lista.size()) {
                ...
                File file = new File("C:\\Users\\alexa\\Desktop\\backup\\"+recebe);
                //// Arquivo ou diretório com novo nome
                File file2 = new File("C:\\Users\\alexa\\Desktop\\backup\\"+result);
