...
public class PostgresRestore {
    ...
    public PostgresRestore() {
        open = new JFileChooser(new File("C:\\Users\\alexa\\Desktop\\backup")); 
        ...
        if ( op == JFileChooser.APPROVE_OPTION ) {
            ...
            final List<String> comandos = new ArrayList<String>();      
            comandos.add("C:\\Program Files\\PostgreSQL\\10\\bin\\pg_restore.exe");
            ...
            comandos.add("C:\\Users\\alexa\\Desktop\\backup\\"+nomeDoArquivo);
